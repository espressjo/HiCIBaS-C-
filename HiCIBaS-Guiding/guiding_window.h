...
enum script_states {IDLE_SCRIPT=0,MOVE,CAPTURE,TMP,ASTROM};
...
protected:
	...
	Gtk::Button capture,download,move_target,coarse_guiding,btn_create_tmp,btn_astrom;
